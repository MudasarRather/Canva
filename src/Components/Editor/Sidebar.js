...
const Sidebar = (props) => {
    ...
    switch (type) {
      ...
      case "image":
        setIsOpened((prevState) =>
          prevState && selected == "image" ? false : true
        );
        setSelected("image");
        break;
      case "shapes":
        setIsOpened((prevState) =>
          prevState && selected == "shapes" ? false : true
        );
        setSelected("shapes");
        break;
      case "templates":
        setIsOpened((prevState) =>
          prevState && selected == "templates" ? false : true
        );
      ...
      case "Elements":
        setIsOpened((prevState) =>
          prevState && selected == "Elements" ? false : true
        );
  ...
  useEffect(() => {
    ...
    axios
      .post(conf.endPoint + "players/template/images/1", {
  ...
  const handleImageClick = (src, width, height) => {
    ...
    if (
      ...
      props.elements[props.selectedElementArrayIndex] !== undefined
    ) {
      if (
        props.elements[props.selectedElementArrayIndex].type == "path" ||
        props.elements[props.selectedElementArrayIndex].type == "rectangle"
      ) {
  ...
  return (
    <div className="sidebar__wrapper">
      ...
      <div
        className={
          isOpened
            ? "editor__sidebarWindow editor__sidebarWindow-opened"
            : "editor__sidebarWindow"
        }
      >
        {selected == "image" && (
          <React.Fragment>
            <div className="editor__window-title">
              <span>Photos</span>
              <img
                onClick={() => props.setisAddImageShowed(true)}
                src={AddImage}
                alt="add photo"
              />
            </div>
            <div className="window__images">
              <div
                onClick={() => {
                  handleImageClick(Image1, 200, 200);
                }}
                className="window__images-item"
              >
              ...
              {imagesList.map((image, index) => (
                <div
                  ...
                  onClick={() => {
                    ...
                    console.log(Image1);
                    console.log(props);
                    handleImageClick(image, 200, 200);
                  }}
                  className="window__images-item"
                >
          ...
          <React.Fragment>
            ...
            <div className="window__images">
              ...
              <div
                onClick={() => {
                  handlePathClick(
                    "M256,0C115.39,0,0,115.39,0,256s115.39,256,256,256s256-115.39,256-256S396.61,0,256,0z"
                  );
                }}
                className="window__images-item "
              >
              ...
              <div
                onClick={() => {
                  handlePathClick(
                    "M507.52,427.39,282.65,52.62a31.09,31.09,0,0,0-53.31,0L4.48,427.39C-7.95,448.11,7,474.47,31.13,474.47H480.87C505,474.47,520,448.11,507.52,427.39Z"
                  );
                }}
                className="window__images-item "
              >
              ...
              <div
                onClick={() => {
                  handlePathClick(
                    "M171.647,2.874L169.3,0L36.582,176.082l-1.414,1.861l142.007,168.378l0.664,0.792l132.685-178.324l1.423-1.853L171.647,2.874z"
                  );
                }}
                className="window__images-item "
              >
              ...
              <div
                onClick={() => {
                  handlePathClick(
                    "M59.662,26.042L30.701,0.458c-0.377-0.332-0.94-0.334-1.319-0.004L0.343,25.79c-0.306,0.267-0.42,0.692-0.289,1.076l11,32.249c0.138,0.405,0.519,0.677,0.946,0.677h35.954c0.427,0,0.806-0.271,0.945-0.674l11.046-32C60.077,26.735,59.966,26.311,59.662,26.042z"
                  );
                }}
                className="window__images-item "
              >
              ...
              <div
                onClick={() => {
                  handleImageClick(ArrowRight, 200, 200);
                }}
                className="window__images-item "
              >
              ...
              <div
                onClick={() => {
                  handleImageClick(PatternImage, 200, 200);
                }}
                className="window__images-item "
              >
              ...
              <div
                onClick={() => {
                  handleImageClick(Soundwaves, 200, 200);
                }}
                className="window__images-item "
              >
        ...
        {selected == "templates" && (
          <React.Fragment>
            ...
            <Templates
              setisModalShowed={props.setisModalShowed}
              handleTemplateClickEditor={props.handleTemplateClickEditor}
            />
          </React.Fragment>
        )}
                  ...
                  <div
                    className={
                      props.selectedId == value.id
                        ? "editor__window-layer editor__window-layer-active"
                        : "editor__window-layer"
                    }
                  >
                    Element {value.id}
                    <div className="editor__window-layer--controls">
                      <button
                        className="editor__window-layer--controls-btnUp"
                        onClick={() => {
                          props.MoveUp(props.selectedId);
                        }}
                      >
                        Move up
                      </button>
                      <button
                        className="editor__window-layer--controls-btnDown"
                        onClick={() => {
                          props.MoveDown(props.selectedId);
                        }}
                      >
                        Move down
                      </button>
